...
var ChatModal = function (props) {
    ...
    var handleSubmit = function (e) {
        ...
        e.preventDefault();
        if (message.trim()) {
            socket_1.default.emit("message:send", { message: message.trim() });
        }
        setShowEmoji(false);
        setMessage("");
        (_a = inputRef.current) === null || _a === void 0 ? void 0 : _a.focus();
    ...
    (0, react_1.useEffect)(function () {
        socket_1.default.emit("messages:getAll");
    }, []);
    (0, react_1.useEffect)(function () {
        scrollToBottom();
    }, [showLead]);
    socket_1.default.on("messages:sendAll", function (dataMessages) {
        setMessages(dataMessages);
        scrollToBottom();
    });
    socket_1.default.on("message:get", function (dataMessage) {
        setMessages(__spreadArray(__spreadArray([], messages, true), [dataMessage], false));
        setTimeout(function () {
            scrollToBottom();
        }, 0);
    });
    socket_1.default.on("lead:new", function () { return setShowLead(true); });
    var pickerStyle = {
        width: "100%",
        position: "absolute",
        bottom: "100%",
